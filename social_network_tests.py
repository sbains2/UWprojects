...
from social_network import get_practice_graph



def test_practice_graph(practice_graph):
    # get the actual graph object from the parameter
    nodes_count = len(practice_graph.nodes)
    assert nodes_count == 6, f"Expected 6 nodes, but found {nodes_count}."

    edges_count = len(practice_graph.edges)
    assert edges_count == 8, f"Expected 8 edges, but found {edges_count}."
